...
public class ChangesTrackerPanel extends javax.swing.JPanel implements ChangesTrackerListener {
    ...
    private void versionsListValueChanged(javax.swing.event.ListSelectionEvent evt) {
    ...
    private void changesListValueChanged(javax.swing.event.ListSelectionEvent evt) {
        if (!evt.getValueIsAdjusting()) {
            // show change
            ChangeWrapper w = (ChangeWrapper)changesList.getSelectedValue();
            if (w == null)
