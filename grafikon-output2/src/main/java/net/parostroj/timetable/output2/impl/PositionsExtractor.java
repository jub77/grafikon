    ...
    public List<Position> getStartPositionsEngines() {
        ...
        for (TrainsCycle ecCycle : this.sortTrainsCycleList(diagram.getCycles(TrainsCycleType.ENGINE_CYCLE))) {
            if (!ecCycle.isEmpty()) {
                ...
                String startTime = diagram.getTimeConverter().convertFromIntToText(start.getStartTime());
    ...
    public List<Position> getEndPositionsEngines() {
        ...
        for (TrainsCycle ecCycle : this.sortTrainsCycleList(diagram.getCycles(TrainsCycleType.ENGINE_CYCLE))) {
            if (!ecCycle.isEmpty()) {
                ...
                String endTime = diagram.getTimeConverter().convertFromIntToText(end.getEndTime());
