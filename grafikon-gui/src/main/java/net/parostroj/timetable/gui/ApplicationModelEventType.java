...
public enum ApplicationModelEventType {
    ...
    MODIFIED_NODE, MODIFIED_LINE, MODEL_CHANGED, MODEL_SAVED, NEW_LINE, MODIFIED_TRAIN_ATTRIBUTE, TRAIN_TYPES_CHANGED,
    DELETE_LINE, ADD_LAST_OPENED, REMOVE_LAST_OPENED;
}
